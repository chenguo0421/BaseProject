...
object MyMenus {
    ...
    fun getFunMenus(context: Context):ArrayList<MyFunBean>{
        ...
        list.add(MyFunBean(MyMenuType.GIFT.ordinal,R.mipmap.sw_my_icon_lipin,context.getString(R.string.portal_my_gift_convert),
            getGiftMenus(context)
        ))
        list.add(MyFunBean(MyMenuType.COLLECT.ordinal,R.mipmap.sw_my_icon_changpin,context.getString(R.string.portal_my_collect),
            getCollectMenus(context)
        ))
        list.add(MyFunBean(MyMenuType.ACTION.ordinal,R.mipmap.sw_my_icon_zanmaobi,context.getString(R.string.portal_my_gather_cat_currency),
            getActMenus(context)
        ))
        return list
    }
