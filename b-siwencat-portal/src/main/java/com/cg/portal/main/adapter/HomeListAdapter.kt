...
import com.cg.base.widget.banner.BannerLayout
import com.cg.base.widget.banner.CardBannerAdapter
...
import com.cg.portal.main.bean.StoryBean
...
class HomeListAdapter(var context: Context, var data:ArrayList<HomeBean.InnerItem>) : RecyclerView.Adapter<HomeListAdapter.MyHolder>(){
    ...
    private fun setZGraphicItem(holder: ZGraphicHolder, position: Int) {
    ...
    private fun setZAudioItem(holder: ZAudioHolder, position: Int) {
    ...
    private fun setZStoryItem(holder: ZStoryHolder, position: Int) {
        holder.itemView.title.text =  data[position].title
        data[position].list?.let {
    ...
    private fun setZVideoItem(holder: ZVideoHolder, position: Int) {
        holder.itemView.title.text =  data[position].title
